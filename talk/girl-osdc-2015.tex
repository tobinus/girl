...
GIRL is developed for the GNOME desktop and requires one audio helper such as Totem (\url{https://developer.gnome.org/totem/}) to be installed for playback and streamripper (\url{http://streamripper.sourceforge.net/}) to be installed for recording live radio streams of supported radio stations. 
